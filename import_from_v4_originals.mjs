...
// List of all IFT/BBS protein v4.json files
const V4_JSON_FILES = [
  '/emcc/au14762/elo_lab/AlphaPulldown/AF3_APD/A0AVF1_IFT56/AF3/AF3_PD_analysis_v4.json',
  '/emcc/au14762/elo_lab/AlphaPulldown/AF3_APD/Hs_Cter_IFT52_46/AF3/AF3_PD_analysis_v4.json',
  '/emcc/au14762/elo_lab/AlphaPulldown/AF3_APD/IFT52_46/AF3/AF3_PD_analysis_v4.json',
  ...
  '/emcc/au14762/elo_lab/AlphaPulldown/AF3_APD/Q96LB3_Q8WYA0_IFT74_81/AF3/AF3_PD_analysis_v4.json',
...
async function importFromV4Files() {
  ...
  console.log(`📁 Processing ${V4_JSON_FILES.length} v4.json files...\n`);
