  ...
  for (const {bait_uniprot, prey_uniprot, validation} of KLINK_2020_VALIDATIONS) {
    try {
      ...
      if (existingValidation) {
        ...
        const hasKlinkStudy = existingValidation.experimental_methods?.some(
          method => method.study?.includes("Klink") && method.study?.includes("2020")
        );
        ...
        const updatedValidation = {
          ...
          validation_summary: {
            ...
            strongest_method: existingValidation.validation_summary.strongest_method || "Cryo-EM",
        ...
        console.log(`🔄 Updated: ${row.bait} ↔ ${row.prey} (added Klink 2020 to existing validation)`);
        added++;
      } else {
