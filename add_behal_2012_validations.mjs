...
const BEHAL_2012_VALIDATIONS = [
  // High confidence: IFT144/140/122 core subcomplex (12S)
  {
    ...
    validation: {
      experimental_methods: [{
        ...
        study: "Behal et al., 2012",
        pmid: "22275356",
        confidence: "high",
        notes: "12S core subcomplex; stable in ift121 mutant"
      }],
      validation_summary: {
        is_validated: true,
        validation_count: 1,
  ...
  // High confidence: Direct binary interaction
  {
    ...
    validation: {
      experimental_methods: [{
        ...
        pmid: "22275356",
        confidence: "medium",
        notes: "Strong Y2H; confirmed with E. coli co-expression"
      }],
      validation_summary: {
        is_validated: true,
        validation_count: 1,
  ...
  // Medium confidence: Y2H + biochemical evidence
  {
    bait_uniprot: UNIPROT.IFT121,
    ...
    validation: {
      experimental_methods: [{
        ...
        pmid: "22275356",
        confidence: "medium",
        notes: "Part of peripheral subcomplex"
      }],
      validation_summary: {
        is_validated: true,
        validation_count: 1,
  ...
  },
  {
    ...
    validation: {
      experimental_methods: [{
        ...
        pmid: "22275356",
        confidence: "medium",
        notes: "Peripheral-to-core bridging interaction"
      }],
      validation_summary: {
        is_validated: true,
        validation_count: 1,
...
async function addValidations() {
  ...
  console.log('Adding Behal et al., JBC 2012 IFT-A validations...\n');
  console.log('(Chlamydomonas IFT-A; Y2H + biochemical reconstitution)\n');
  console.log('First comprehensive study identifying IFT144/140/122 core subcomplex\n');

  for (const {bait_uniprot, prey_uniprot, validation} of BEHAL_2012_VALIDATIONS) {
    try {
  ...
  console.log(`\nTotal processed: ${BEHAL_2012_VALIDATIONS.length}`);
